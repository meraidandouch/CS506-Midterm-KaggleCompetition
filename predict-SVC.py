...
X_train_processed = X_train[['Score', 'sentiment_summary', 'HelpBin', 'Helpfulness', 'good', 'bad', 'great', 'better', 'fun']]
X_test_processed = X_test[['sentiment_summary','HelpBin','Helpfulness','good','bad', 'great', 'better', 'fun']]
X_submission_processed = X_submission[['sentiment_summary','HelpBin','Helpfulness','good', 'bad', 'great', 'better', 'fun']]
...
X_train_processed = X_train_processed.sample(n = 100000)
...
clf = SVC(kernel='linear',probability=True).fit(X_train_processed,y_train_processed) #support vector machine 
...
Y_test_predictions = clf.predict(X_test_processed)
X_submission['Score'] = clf.predict(X_submission_processed)
