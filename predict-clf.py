...
X_train_processed = X_train[['Score', 'sentiment_summary', 'Helpfulness', 'great', 'bad', 'better', 'funni', 'time']]
X_test_processed = X_test[['sentiment_summary', 'Helpfulness','great','bad', 'better', 'funni', 'time']]
X_submission_processed = X_submission[['sentiment_summary', 'Helpfulness','great', 'bad', 'better', 'funni', 'time']]
...
clf = DecisionTreeClassifier(max_depth=md).fit(X_train_processed, y_train_processed)
